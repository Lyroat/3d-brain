...
export const REGION_DATA: Record<string, RegionInfo> = {
  ...
  // === 脑干 ===
  'brainstem': { name: 'brainstem', label: '脑干', description: '控制基本生命功能，连接大脑与脊髓。包含中脑、脑桥和延髓。', functions: ['呼吸调控', '心率控制', '觉醒', '反射'] },
  'substantia-nigra': { name: 'substantia-nigra', label: '黑质', description: '位于中脑，是多巴胺能神经元的主要来源。退化导致帕金森病。', functions: ['多巴胺分泌', '运动启动', '奖赏信号'] },
...
export const BRAIN_TREE: TreeNode[] = [
  ...
  },
  {
    id: 'brainstem-group', label: '脑干', children: [
      { id: 'r-brainstem', label: '脑干（中脑+脑桥+延髓）', regionName: 'brainstem' },
      { id: 'r-substantia-nigra', label: '黑质（中脑）', regionName: 'substantia-nigra' },
    ]
  },
];
